        ...
        <form id="login-form" class="space-y-4 w-full">
            ...
            <div class="mb-6">
                <div class="flex justify-evenly md:justify-normal">
                    ...
                    {{--                        </button>--}}
                    <input name="captcha"
                           class="bg-gray-50 border border-gray-300 h-10 mt-2 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
