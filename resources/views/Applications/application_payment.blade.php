                        ...
                        <form id="application-payment" method="post" action="/PayApplicationFee" enctype="multipart/form-data">
                            ...
                            <div class="mb-6" id="offline_payment_div" hidden="hidden">
                                <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md mb-6"
                                    ...
                                    <div class="flex">
                                        ...
                                        <div>
                                            ...
                                            Rials using one of the following methods (bank account number, bank card number or Shaba number) and upload the image of your bank slip from the box below.
                                        </div>
                                    </div>
                                </div>
                                @foreach($paymentMethods as $methods)
                                    @if(empty($methods->description)) @continue @endif
                                        @php
                                            $descriptions = null;
                                ...
                                <input
                                    ...
                                    id="document_file" name="document_file" type="file" required
                            ...
                            <div class="mb-6" id="online_payment_div" hidden="hidden">
                                <div class="bg-teal-100 border-t-4 border-teal-500 rounded-b text-teal-900 px-4 py-3 shadow-md mb-6"
                                    ...
                                    <div class="flex">
                                        ...
                                        <span hidden="" id="deadline">{{ $deadline }}</span>
                                        <div>
                                            You must pay the amount of {{ number_format($checkApplication->applicationInfo->applicationTimingInfo->fee) }} Rials through the bank payment portal. For this, click on the pay button
                                        </div>
                                    </div>
                                </div>
                            </div>
