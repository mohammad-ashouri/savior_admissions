    ...
    <div id="content" class="p-4 md:ml-14 transition-all duration-300 bg-light-theme-color-base dark:bg-gray-800">
        <div class="p-4 rounded-lg dark:border-gray-700 mt-20 ">
            <div class="grid grid-cols-1 gap-4 mb-4">
                <h1 class="text-3xl font-semibold text-black dark:text-white ">All Education Types</h1>
            </div>
            ...
            <div class="grid grid-cols-1 gap-4 mb-4">
                <div class="flex justify-between">
                    ...
                    <div class="flex">
                        @can('education-type-create')
                            <a href="{{ route('EducationTypes.create') }}">
                                <button type="button"
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                        @foreach($types as $educationType)
                            <tr
                                ...
                                <td class="px-6 py-4 text-center">
                                    <!-- Modal toggle -->
                                    @can('education-type-edit')
                                        <a href="{{ route('EducationTypes.edit',$educationType->id) }}" type="button"
