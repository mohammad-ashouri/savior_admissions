        ...
        <div class="p-4 rounded-lg dark:border-gray-700 mt-20 ">
            ...
            <div class="grid grid-cols-1 gap-4 mb-4">
                <h1 class="text-3xl font-semibold text-black dark:text-white ">Edit Tuition Invoices
                    : {{ $tuitionInvoiceDetails[0]->tuitionInvoiceDetails->applianceInformation->id}}
                    - {{ $tuitionInvoiceDetails[0]->tuitionInvoiceDetails->applianceInformation->student_id}}
                    - {{ $tuitionInvoiceDetails[0]->tuitionInvoiceDetails->applianceInformation->studentInfo->generalInformationInfo->first_name_en }} {{ $tuitionInvoiceDetails[0]->tuitionInvoiceDetails->applianceInformation->studentInfo->generalInformationInfo->last_name_en }}</h1>
            </div>
            <div class="grid grid-cols-1 gap-4 mb-4">
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
                        ...
                        @foreach($tuitionInvoiceDetails as $invoice)
                            <tr class="odd:bg-white even:bg-gray-300 bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                                ...
                                <th scope="row"
                                    ...
                                    <input type="number" id="s2_1" value="{{$invoice->amount}}"
                        ...
                        <tr class="odd:bg-white even:bg-gray-300 bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                            ...
                            <th scope="row"
                                class="flex items-center text-center px-3 py-1 text-gray-900 whitespace-nowrap dark:text-white">
                                Sum Amount: {{ number_format($tuitionInvoiceDetails->sum('amount')) }} IRR
                            </th>
                            <th scope="row"
                                class=" items-center text-center px-3 py-1 text-gray-900 whitespace-nowrap dark:text-white">
                            </th>
