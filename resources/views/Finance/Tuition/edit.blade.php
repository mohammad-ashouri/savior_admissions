                                                        ...
                                                        <td class="p-4">
                                                            ...
                                                            @else
                                                                ...
                                                                <label
                                                                    class="block mb-1 mt-2 text-sm font-medium text-gray-900 dark:text-white">Advance
                                                                    payment in two
                                                                    installments {{ isset($twoInstallmentDetails['two_installment_advance']) ? $twoInstallmentDetails['two_installment_advance'] : 0 }}</label>
                                                                <label
                                                                    class="block mb-1 mt-2 text-sm font-medium text-gray-900 dark:text-white">The
                                                                    amount of each
                                                                    installment {{ isset($twoInstallmentDetails['two_installment_each_installment']) ? $twoInstallmentDetails['two_installment_each_installment'] : 0 }}</label>
                                                            @endif
                                                        </td>
                                                        <td class="p-4">
                                                            @php
                                                            ...
                                                            @else
                                                                ...
                                                                <label
                                                                    class="block mb-1 mt-2 text-sm font-medium text-gray-900 dark:text-white">Advance
                                                                    payment in four
                                                                    installments {{ isset($fourInstallmentDetails->four_installment_advance) ? $fourInstallmentDetails->four_installment_advance : 0 }}</label>
                                                                <label
                                                                    class="block mb-1 mt-2 text-sm font-medium text-gray-900 dark:text-white">The
                                                                    amount of each
                                                                    installment {{ isset($fourInstallmentDetails->four_installment_each_installment) ? $fourInstallmentDetails->four_installment_each_installment : 0 }}</label>
                                                            @endif
                                                        </td>
                                                        <td class="p-4 text-center">
