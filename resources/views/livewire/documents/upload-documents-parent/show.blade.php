            ...
            <div class="lg:col-span-2 col-span-3 ">
                <div class=" bg-white dark:bg-gray-800 dark:text-white p-8 rounded-lg mb-4">
                    ...
                    <div class="grid gap-6 mb-6">
                        ...
                        @if(auth()->user()->hasRole('Admissions Officer') and $student_appliance_status->documents_uploaded_approval!=1)
                            <div class="flex w-full">
                                <form class="confirm-evidences" wire:submit.prevent="setStatus">
                                    <div class="flex">
                                        @csrf
                                        <div class="mr-3">
                                            <label for="status"
                                            ...
                                            <select name="status" id="status" wire:model="status" required
