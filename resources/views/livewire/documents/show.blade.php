<div
    ...
    id="content" class="p-4 sm:ml-14 transition-all duration-300 bg-light-theme-color-base dark:bg-gray-800">
    <div class="p-4 rounded-lg dark:border-gray-700 mt-20">
        ...
        <div class="flex items-center justify-center pb-4 md:pb-8 flex-wrap mt-8 md:mt-8">
            ...
            @foreach ($myDocumentTypes as $id=>$type)
                <button type="button" data-type-id="{{ $id }}"
        ...
        <!-- Main modal -->
        <form wire:submit.prevent="createDocument" :class="{'hidden': !showModal}">
                ...
                <div class="relative w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div
                            ...
                            <p class="text-blue-600" wire:loading>Uploading...</p>
                            <button type="button"
                                    x-on:click.self="toggleModal()"
