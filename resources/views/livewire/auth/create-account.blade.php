        ...
        <div class="p-6">
            <form wire:submit.prevent="register">
                <div class="grid lg:grid-cols-4 lg:gap-3">
                    ...
                    <div class="mb-4">
                        <label for="last_name_en" class="block text-gray-700 text-sm font-medium mb-2">Last Name</label>
                    ...
                    <div class="mb-4">
                        <label for="birthdate" class="block text-gray-700 text-sm font-medium mb-2">Birthdate</label>
                    ...
                    <div class="mb-4">
                        <label for="birthplace" class="block text-gray-700 text-sm font-medium mb-2">Birthplace</label>
                    ...
                    <div class="mb-4">
                        <label for="mobile" class="block text-gray-700 text-sm font-medium mb-2">Mobile Number
                            (Username)</label>
                        <input type="text" id="mobile" wire:model="mobile" placeholder="+989123456789"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                        >
