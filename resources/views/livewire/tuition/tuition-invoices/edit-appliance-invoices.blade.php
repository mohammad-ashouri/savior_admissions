                ...
                <div class="grid grid-cols-2 gap-2">
                    ...
                    <div class="flex p-2  relative overflow-x-auto shadow-md sm:rounded-lg bg-white">
                        ...
                        <h4 class="text-xl font-semibold">Price:
                            {{ number_format(@$tuition_invoice_details[0]->tuitionInvoiceDetails->applianceInformation->grantedFamilyDiscounts->discount_price) }}
                        </h4>
                        <h4 class="text-xl font-semibold">Percent:
                            {{ @$tuition_invoice_details[0]->tuitionInvoiceDetails->applianceInformation->grantedFamilyDiscounts->discount_percent }}
                            %
                        </h4>
                        <h4 class="text-xl font-semibold">Signed Student Number:
                            {{ @$tuition_invoice_details[0]->tuitionInvoiceDetails->applianceInformation->grantedFamilyDiscounts->signed_child_number }}
                        </h4>
                    </div>
                </div>
                ...
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400 ">
                        ...
                        @foreach($tuition_invoice_details as $invoice)
                            <tr wire:key="invoice-{{ $invoice->id }}" class="odd:bg-white even:bg-gray-300 bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                                <td class="w-4 p-4">
                                ...
                                <th scope="row"
                                    ...
                                    <input type="number" wire:model="amounts.{{ $invoice->id }}" value="{{$invoice->amount}}"
