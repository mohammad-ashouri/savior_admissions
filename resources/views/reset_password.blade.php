...
<head>
    ...
    <title>Savior Reset password</title>
</head>
    ...
    <div class="bg-white dark:bg-gray-800 lg:w-4/6 w-full lg:m-0 m-8 rounded-lg shadow-lg flex">
        ...
        <div class="lg:w-1/2 w-full flex flex-col justify-center items-center p-8">
            ...
            <form id="login-form" class="space-y-4 w-full">
                ...
                <div class="mb-6">
                    <label for="Confirm_new_password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirm New Password
                    </label>
                ...
                <div class="flex justify-between items-start mb-6">
                    <div class="flex items-center h-5">
                        <input id="remember" type="checkbox" value=""
                            ...
                            >
                            <label for="remember" class="ml-2 text-sm font-medium text-gray-900 dark:text-white">I accept the <a href="#" class="text-blue-500">Terms and Conditions</a></label>
                    </div>
