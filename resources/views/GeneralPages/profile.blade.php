                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                <div>
                                    <label for="first_name"
                                        ...
                                        name</label>
                                    <input type="text" id="first_name" value="{{ $myInfo->name }}" disabled
                                ...
                                <div>
                                    <label for="last_name"
                                        ...
                                        name</label>
                                    <input type="text" id="last_name" value="{{ $myInfo->family }}" disabled
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    <label for="email"
                                        ...
                                        address</label>
                                    <input type="email" id="email" value="{{ $myInfo->email }}" disabled
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    ...
                                    <input type="tel" id="phone" name="phone"
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                           placeholder="+982531234567" pattern="+98[0-9]{10}" required>
                                </div>
                                <div>
                                ...
                                <div>
                                    ...
                                    <label for="Role"
                                           class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">@if(!empty($myInfo->getRoleNames()))
                                            @foreach($myInfo->getRoleNames() as $v)
                                                {{ $v }}
                                            @endforeach
                                        @endif
                                    </label>
