                    ...
                    <div>
                        <div class="lg:flex grid lg:items-center items-start lg:space-x-4">
                            ...
                            <div class="font-bold dark:text-white">
                                <div class="text-l">{{ $myGeneralInformation->user->name }} {{ $myGeneralInformation->user->family }}</div>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                <div>
                                    <label for="first_name"
                                        ...
                                        name</label>
                                    <input type="text" id="first_name" value="{{ $myGeneralInformation->user->name }}" disabled
                                ...
                                <div>
                                    <label for="last_name"
                                        ...
                                        name</label>
                                    <input type="text" id="last_name" value="{{ $myGeneralInformation->user->family }}" disabled
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    <label for="father-name"
                                        ...
                                        name</label>
                                    <input type="text" id="father-name" name="father-name" @if($myGeneralInformation->father_name!==null) value=" {{ $myGeneralInformation->father_name }}" disabled @endif
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    ...
                                    <select @if($myGeneralInformation->gender!==null) disabled @endif required id="gender" name="gender"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    >
                                        <option value="" selected>Choose an option...</option>
                                        <option @if($myGeneralInformation->gender==='male') selected @endif value="male">Male</option>
                                        <option @if($myGeneralInformation->gender==='female') selected @endif  value="female">Female</option>
                                    </select>
                                </div>
                                <div>
                                    <label for="Birthdate"
                                           class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Birthdate</label>
                                    <input type="date" id="Birthdate" name="Birthdate" @if($myGeneralInformation->birthdate!==null) value="{{ $myGeneralInformation->birthdate }}" disabled @endif
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="Country" name="Country" @if($myGeneralInformation->country!==null) value=" {{ $myGeneralInformation->country }}" disabled @endif
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="city" name="city" @if($myGeneralInformation->state_city!==null) value=" {{ $myGeneralInformation->state_city }}" disabled @endif
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    <label for="email"
                                        ...
                                        address</label>
                                    <input type="email" id="email" value="{{ $myGeneralInformation->user->email }}" disabled
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    <label for="mobile"
                                        ...
                                        number</label>
                                    <input type="tel" id="mobile" value="{{ $myGeneralInformation->user->mobile }}" disabled
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    ...
                                    <input type="text" id="address" name="address" @if($myGeneralInformation->address!==null) value=" {{ $myGeneralInformation->address }}" disabled @endif
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    <label for="phone"
                                        ...
                                        number</label>
                                    <input type="tel" id="phone" name="phone" @if($myGeneralInformation->phone!==null) value=" {{ $myGeneralInformation->phone }}" disabled @endif
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    <label for="zip/postal code"
                                        ...
                                        code</label>
                                    <input type="text" id="zip/postal code" name="zip/postalcode" @if($myGeneralInformation->postal_code!==null) value=" {{ $myGeneralInformation->postal_code }}" disabled @endif
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
