                            ...
                            <div class="grid gap-6 mb-6 md:grid-cols-2">
                                <div>
                                    <label for="first_name_en"
                                        ...
                                        name (English)</label>
                                    <input type="text" id="first_name_en" value="{{ $myGeneralInformation->first_name_en }}"
                                           disabled
                                ...
                                <div>
                                    <label for="last_name_en"
                                        ...
                                        name (English)</label>
                                    <input type="text" id="last_name_en" value="{{ $myGeneralInformation->last_name_en }}"
                                           disabled
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    <label for="first_name_fa"
                                           class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">First
                                        name (Persian)</label>
                                    <input type="text" id="first_name_fa" value="{{ $myGeneralInformation->first_name_fa }}"
                                           disabled
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                           required>
                                </div>
                                <div>
                                    <label for="last_name_fa"
                                           class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Last
                                        name (Persian)</label>
                                    <input type="text" id="last_name_fa" value="{{ $myGeneralInformation->last_name_fa }}"
                                           disabled
                                           class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                           required>
                                </div>
