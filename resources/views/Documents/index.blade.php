                ...
                @foreach($myDocumentTypes as $typeId)
                    ...
                    @if($documentType)
                        <button type="button" data-type-id="{{$typeId}}"
                                class="text-gray-900 border border-white hover:border-gray-200 dark:border-gray-900 dark:bg-gray-900 dark:hover:border-gray-700 bg-white focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-full text-base font-medium px-3 py-2.5 text-center mb-3 dark:text-white dark:focus:ring-gray-800 type-filter">
                            {{ $documentType->name }}
                        </button>
                    @endif
                @endforeach
                ...
                @foreach($myDocuments as $document)
                    ...
                    <div class="cursor-pointer img-hover-zoom img-hover-zoom--xyz document-div"
                        ...
                        <button data-modal-target="openImage" data-modal-toggle="openImage"
                                ...
                                type="button">
                            <img class="h-auto max-w-full rounded-lg "
                                 src="{{ $document->src }}" alt="">
                            <p class="text-center font-normal text-gray-700 dark:text-gray-400">{{ $document->id . ' - ' . $document->documentType->name . '- ' . $document->created_at }}
                            </p>
                        </button>
                    </div>
                @endforeach
                    ...
                    <div class="relative w-full max-w-2xl max-h-full">
                        ...
                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                            ...
                            <div class="p-6 space-y-6">
                                ...
                                <img id="image_preview" class="w-full h-auto" src=""
