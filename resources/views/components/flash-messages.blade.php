...
@if(session()->has('success') || session()->has('error') || session()->has('warning') || session()->has('info') || $errors->any())
    <div class="pt-3 mb-4">
        <div class="mx-auto">
            ...
            @if ($errors->any())
                <div
                    class="mb-6 bg-red-50 border-l-4 border-red-500 rounded-r px-4 py-3 shadow-md dark:bg-red-900/20 dark:border-red-600 transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div class="flex items-start">
                            <div class="ml-3">
                                <div
                                    class="!text-red-500 px-4 py-3 rounded relative dark:text-red-200 flex items-center justify-between">
