                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <label for="name"
                                    ...
                                    Name</label>
                                <input type="text" id="name" value="{{ old('name') }}{{ $academicYearClass->name }}"
                                       name="name"
                            ...
                            <div>
                                ...
                                <select id="academic_year" name="academic_year"
                                    ...
                                    @foreach($academicYears as $academicYear)
                                        <option
                                            @if(old('academic_year')==$academicYear->id or $academicYearClass->academic_year==$academicYear->id) selected
                            ...
                            <div>
                                ...
                                <select id="level" name="level"
                                    ...
                                    @foreach($levels as $id => $level)
                                        <option @if(old('level')==$id or $academicYearClass->level == $id) selected
                            ...
                            <div>
                                ...
                                <select id="education_type" name="education_type"
                                    ...
                                    @foreach($educationTypes as $educationType)
                                        <option
                                            @if(old('education_type')==$educationType->id or $academicYearClass->education_type == $educationType->id) selected
                            ...
                            <div>
                                ...
                                <input type="number" id="capacity"
                                       value="{{ old('capacity') }}{{ $academicYearClass->capacity }}" name="capacity"
                                       max="60" min="1"
                                       class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            ...
                            <div>
                                ...
                                <select id="education_gender" name="education_gender"
                                    ...
                                    @foreach($educationGenders as $educationGender)
                                        <option
                                            @if(old('education_gender')==$educationGender->id or $academicYearClass->education_gender == $educationGender->id) selected
