        ...
        <div class="border border-gray-700 rounded-lg w-full ">
            ...
            <div class="flex flex-wrap">
                <button type="button" id="step-1-btn"
                        class="tab-btn w-full md:w-2/4 lg:w-1/7 py-2 text-white px-4 bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400 rounded-tl-lg rounded-tr-lg"
                        data-tab="tab1">Step 1
                </button>
                <button type="button" id="step-2-btn"
                        class="tab-btn w-full md:w-2/4 lg:w-1/7 py-2 text-white px-4 bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400"
