                    ...
                    @else
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            @foreach($studentAppliances as $appliance)
                                @php
                                    $applicationReservation=ApplicationReservation::with('levelInfo')->where('student_id',$appliance->studentInfo->id)->where('payment_status',1)->latest()->first();
                                @endphp
                                <tr
                                    ...
                                    <th scope="row"
                                        class=" items-center text-center border text-gray-900 whitespace-nowrap dark:text-white">
                                            <div
                                                class="text-base font-semibold">{{ $appliance->studentInformations->guardian }} - {{ $appliance->studentInformations->guardianInfo->generalInformationInfo->first_name_en }} {{ $appliance->studentInformations->guardianInfo->generalInformationInfo->last_name_en }} </div>
                                    </th>
                                    <th scope="row"
                                        class=" items-center text-center border text-gray-900 whitespace-nowrap dark:text-white">
                                            <div
